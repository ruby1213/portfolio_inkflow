  ...
  return (
    ...
    >
      ...
      <div className="max-w-230 w-full mx-auto">
        ...
        <h1 className="text-accent font-mincho font-bold text-[clamp(48px,11vw,128px)] leading-none tracking-[.01em] m-0  opacity-0 animate-[fadeUp_1.3s_.4s_forwards]">
          YURU
        ...
        <div className="mt-30 text-[12px] tracking-[.12em] text-fg-dim opacity-0 flex flex-col items-center gap-2 animate-[fadeUp_1.3s_1.3s_forwards,floaty_3.5s_2.6s_ease-in-out_infinite]">
